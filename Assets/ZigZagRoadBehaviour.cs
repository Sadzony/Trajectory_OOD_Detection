...
public class ZigZagRoadBehaviour : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        if (currentCentreLine != null)
        {
            ...
            leftZigZagPoint = centreLines[0].position + Vector3.left* 0.075f;
            rightZigZagPoint = centreLines[2].position + Vector3.right * 0.075f;
            ...
            switch (index)
            {
                ...
                case 1:
                    nextZigZagTarget = Random.value < 0.5f
                        ? leftZigZagPoint
                        : rightZigZagPoint;
                    currentTimeToZigZag = currentTimeToZigZag / 2;
                    break;
